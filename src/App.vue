                ...
                <div class="cart-list-item">
                    ...
                    <div class="item-details-with-actions">
                        <div class="item-details">
                            ...
                            <p class="on-backorder-status" v-else="shoppingCartItems[0].isInStock"> <i class="fa-solid fa-hourglass-half"></i> On backorder</p>
                        </div>
                ...
                <div class="cart-list-item">
                    ...
                    <div class="item-details-with-actions">
                        <div class="item-details">
                            ...
                            <p class="on-backorder-status" v-else="shoppingCartItems[1].isInStock"> <i class="fa-solid fa-hourglass-half"></i> On backorder</p>
                        </div>
                        <div class="item-actions">
                            <div class="quantity-selector">
                ...
                <div class="cart-list-item">
                    ...
                    <div class="item-details-with-actions">
                        <div class="item-details">
                            ...
                            <p class="on-backorder-status" v-else="shoppingCartItems[2].isInStock"> <i class="fa-solid fa-hourglass-half"></i> On backorder</p>
                        </div>
                        <div class="item-actions">
                            <div class="quantity-selector">
                ...
                <div class="cart-list-item">
                    ...
                    <div class="item-details-with-actions">
                        <div class="item-details">
                            ...
                            <p class="on-backorder-status" v-else="shoppingCartItems[3].isInStock"> <i class="fa-solid fa-hourglass-half"></i> On backorder</p>
                        </div>
                        <div class="item-actions">
                            <div class="quantity-selector">
                ...
                <div class="cart-list-item">
                    ...
                    <div class="item-details-with-actions">
                        <div class="item-details">
                            ...
                            <p class="on-backorder-status" v-else="shoppingCartItems[4].isInStock"> <i class="fa-solid fa-hourglass-half"></i> On backorder</p>
                        </div>
                        <div class="item-actions">
                            <div class="quantity-selector">
